...
import axios from 'axios';
 ...
 useEffect(()=>{
  const postsend = async()=>{
    ...
    console.log('post data is fetch')
    console.log(response.data.statusdata1)
    setPost(response.data.statusdata1)
  }
 })
  const handleLike = () => {
    setLiked(!liked);
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4"> <div className="max-w-sm md:max-w-lg mx-auto bg-white shadow-2xl rounded-3xl overflow-hidden w-full">
      {/* Header */}
        ...
        <div className="flex items-center space-x-3">
          <div className="relative">
            <img 
              ...
              alt="Profile"
              className="w-8 h-8 md:w-10 md:h-10 rounded-full object-cover ring-2 ring-pink-500 ring-offset-2"
            />
            <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-green-500 border-2 border-white rounded-full"></div>
          </div>
          <div>
            <h3 className="font-semibold text-sm md:text-base text-gray-900">alex_photographer</h3>
      ...
      <div className="p-4">
        ...
        <div className="mb-3">
          ...
          <p className="text-gray-500 text-xs md:text-sm mt-1">#photography #mountains #goldenhour #nature</p>
        </div>

        {/* View all comments */}
        <button 
          onClick={() => setShowComments(!showComments)}
          className="text-gray-500 text-xs md:text-sm mb-3 hover:text-gray-700 transition-colors"
        >
        ...
        {/* Add Comment */}
        <div className="flex items-center space-x-2 md:space-x-3 pt-3 border-t border-gray-200">
          <img 
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-3 py-2 bg-gray-100 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all"
            />
